...
let boyBlinkTimer = 0, boyHappy = false, boyBreathPhase = 0;
...
function petBoy() {
    ...
    const _pool = (window.boyDbQuotes || []).length ? window.boyDbQuotes : boyPhrases;
